...
const userRoutes = require("./routes/userRoutes"); // ✅ /users, /search/users, /teachers
...
// ✅ 🔥 FIXED PATH → เพื่อไม่ให้กลายเป็น /api/users/users
app.use("/api", userRoutes); // ⬅️ แก้ตรงนี้
